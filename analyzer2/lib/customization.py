...
class Contact(Customizations):
    ...
    def pre_analysis(self):
        ...
        # # TODO: these are old! you should recompute them after a while
        # # from old
    ...
    # def getFcts(self):
    #     return [(0x9380, 0xa07f), # br_aes_x86ni_ctr_run
    #             (0x6e00, 0x8dbe), # x86ni_keysched
    #             (0x5060, 0x6b9a), # br_ghash_pclmul
    #             (0x132a0, 0x13b9f), # sabd_lookup_hash_salt
    #             (0x2ff0, 0x31ac)] # sgxsd_enclave_get_next_report
