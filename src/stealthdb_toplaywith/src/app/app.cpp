...
// #define ENCLAVE_FILENAME "/home/flavio/SgxMonitor/src/stealthdb_toplaywith/src/enclave/enclave.debug.signed.so"
  ...
  // int resp_enclave2;
	...
	// ret = generateKeyEnclave(global_eid, &resp_enclave2, sealed_key_b_X, SEALED_KEY_LENGTH);
	// if (ret != SGX_SUCCESS)
	// 		return ret;
  ...
  ctxPc[13].cpu_context.rbp = mSp - 0x18; // I predict next frame
  ...
  ctxPc1[5].cpu_context.rbp = mSp - 0x18; // I predict next frame
  // NOTE: this is an HARDCODE offest, to recompute at any compilation!!
