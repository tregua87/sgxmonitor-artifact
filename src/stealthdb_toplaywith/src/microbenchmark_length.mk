...
$(APP_DIR)/enclave_u.c: $(SGX_EDGER8R) $(ENCLAVE_DIR)/enclave.edl
	@cd $(APP_DIR) && $(SGX_EDGER8R) --untrusted ../$(ENCLAVE_DIR)/enclave.edl --search-path $(SGX_INCLUDE_PATH)
	@echo "GEN  =>  $@"
...
$(APP_DIR)/app: $(APP_DIR)/enclave_u.o $(APP_DIR)/app.cpp  ../../benchmark/Dump.o ../../client/Clientpic.o
	$(CXX) $(CXXFLAGS) $^ -o $@ $(LDFLAGS) -I../../../inc
	@echo "CC extension <=  $<"
	@mkdir -p $(BUILD_DIR)
