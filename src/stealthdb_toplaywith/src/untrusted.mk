...
DATA = $(EXTENSION_DIR)/encdb--0.0.2.sql  # scripts to install
...
$(UNTRUSTED_DIR)/enclave_u.c: $(SGX_EDGER8R) $(ENCLAVE_DIR)/enclave.edl
	@cd $(UNTRUSTED_DIR) && $(SGX_EDGER8R) --untrusted ../$(ENCLAVE_DIR)/enclave.edl --search-path $(SGX_INCLUDE_PATH)
	@echo "GEN  =>  $@"
...
$(EXTENSION_DIR)/%.o: $(EXTENSION_DIR)/%.c
	@$(CC) $(CFLAGS) $(PSQL_CPPFLAGS) -o $@ -c $^ -I../../../inc 
	@echo "CC extension <=  $<"

$(UNTRUSTED_DIR)/encdb.so: $(UNTRUSTED_DIR)/enclave_u.o $(CXX_OBJS) $(C_OBJS) ../../benchmark/Dump.o ../../client/Clientpic.o
