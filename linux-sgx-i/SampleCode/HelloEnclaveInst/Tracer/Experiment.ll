...
@__NOT_INSTRUMENT_THIS = dso_local global i8* null, align 8
...
declare void @_Z10traceedgecPv(i8*)

declare void @_Z15traceassigmentfPvS_(i8*, i8*)

declare void @_Z10traceframePv(i8*)
...
!1 = !{!"clang version 10.0.0 (https://github.com/llvm/llvm-project.git d4c50f7326a063e073b380c4a7a5c10dd02a5e5d)"}
